  ...
  return (
    <Box bg="beige" mt="16" borderRadius="10" px="12" py={{ base: 12, lg: 0 }}>
      <Grid templateColumns={{ base: "1fr", lg: "repeat(4, 1fr)" }} templateRows={{ base: "auto", lg: "repeat(12, 1fr)" }}>
        ...
        <GridItem gridColumn={{ base: "1fr", lg: "1 / 3" }} gridRow={{ base: "auto", lg: "7 / 13" }} order={{ base: "5", md: "auto" }}>
          <Box display="flex" alignItems="center" justifyContent="center" height="100%" mr={{ base: 0, lg: 6 }}>
            <Image src="/images/home_pics/illu-offrecouplee.svg" alt="" width={{ base: "120px", lg: "511px" }} />
          </Box>
        </GridItem>
        <GridItem gridColumn={{ base: "1fr", lg: "3 / 5" }} gridRow={{ base: "auto", lg: "1 / 3" }} order={{ base: "1", md: "auto" }}>
        ...
        <GridItem gridColumn={{ base: "1fr", lg: "3 / 5" }} gridRow={{ base: "auto", lg: "3 / 5" }} order={{ base: "3", md: "auto" }}>
        ...
        <GridItem gridColumn={{ base: "1fr", lg: "3 / 5" }} gridRow={{ base: "auto", lg: "5 / 9" }} order={{ base: "4", md: "auto" }}>
        ...
        <GridItem gridColumn={{ base: "1fr", lg: "3 / 5" }} gridRow={{ base: "auto", lg: "9 / 13" }} order={{ base: "6", md: "auto" }}>
          <Text as="h2" variant="homeEditorialH2">
