      ...
      <SimpleGrid columns={{ sm: 1, md: 2 }} spacing="40px" alignItems={"center"} mt={12}>
        <Box pl={{ base: 5 }}>
          ...
          <Box variant="homeEditorialText">
            ...
            <Link variant="homeEditorialLink" href="https://labonnealternance.pole-emploi.fr" isExternal>
              la Bonne Alternance
            </Link>
            ,{" "}
            <Link variant="homeEditorialLink" href="https://www.1jeune1solution.gouv.fr" isExternal>
              1jeune1solution
            </Link>
            ,{" "}
            <Link variant="homeEditorialLink" href="https://www.parcoursup.fr" isExternal>
              parcoursup
            </Link>{" "}
            et bien d’autres.
          </Box>
