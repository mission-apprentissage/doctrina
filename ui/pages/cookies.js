        ...
        <GridItem px={4} colSpan={[12, 12, 12, 7]}>
          <Box>
            ...
            <Text as="p" mb="2">
              ...
              <Link
                url="https://labonnealternance.beta.gouv.fr/"
                aria-label="Redirection vers la page d'accueil"
                title="La bonne alternance"
              />{" "}
              permettre le bon fonctionnement du site internet et l’utilisation des principales fonctionnalités du site.
            </Text>
            <Text as="p" mb="2">
            ...
            <Text as="p" mb="2">
              ...
              afin d’effectuer de la mesure d’audience, des analyses statistiques dans le but d&apos;améliorer
            ...
            <Text as="p" mb="2">
              ...
              <ExternalLink
                ...
                title="La bonne alternance"
              />
              , ainsi que les conditions d’accès à certains services et d’entrainer des dysfonctionnements de certaines
              fonctionnalités.
            </Text>
