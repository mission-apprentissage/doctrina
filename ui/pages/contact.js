      ...
      <div className="row">
        ...
        <div className="col-12 col-md-8 mb-3">
          ...
          <div className="text-break">
            ...
            <p>
              <b>Vous êtes candidat,</b> écrivez-nous en cliquant sur <br />
              <a href="mailto:labonnealternance@apprentissage.beta.gouv.fr?subject=Page%20Contact%20-%20Candidat">
                ce lien
              </a>
            </p>
            <p>
              <b>Vous êtes un organisme de formation,</b> écrivez-nous en cliquant sur <br />
              <a href="mailto:labonnealternance@apprentissage.beta.gouv.fr?subject=Page%20Contact%20-%20OF">
                ce lien
              </a>
            </p>
            <p>
              <b>Vous êtes une entreprise recevant des candidatures spontanées,</b> écrivez-nous en cliquant sur {" "}
            ...
            <p>
              <b>Vous êtes une entreprise intéressée par notre service de dépôt d&apos;offre simplifié,</b> écrivez-nous en cliquant sur {" "}
