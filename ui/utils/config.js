const config = {
  ...
  dev: {
    env: "recette",
    urls: [
      /^doctrina-recette.apprentissage.beta.gouv.fr$/g,
      /^labonnealternance-recette.apprentissage.beta.gouv.fr$/g,
      /^labonnealternance.beta.pole-emploi.fr$/g,
    ],
  ...
  prod: {
    env: "production",
    urls: [
      /^doctrina.apprentissage.beta.gouv.fr$/g,
      /^labonnealternance.apprentissage.beta.gouv.fr$/g,
      /^labonnealternance.pole-emploi.fr$/g,
    ],
